deepZEN-curator  —  v0.6  (Ankarafantsika + Ranomafana, 2026-05-19)
===================================================================
...
1. Unzip this folder somewhere convenient (e.g. your Desktop).
   The file inside is called "start.bat.txt" (renamed that way so
   email scanners let the zip through). Right-click → Rename →
   delete the trailing ".txt" so it becomes "start.bat".
